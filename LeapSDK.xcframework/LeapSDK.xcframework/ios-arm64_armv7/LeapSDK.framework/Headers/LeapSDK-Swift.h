...
#ifndef LEAPSDK_SWIFT_H
#define LEAPSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LeapSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Leap * _Nonnull shared;)
...
- (Leap * _Nullable)withBuilder:(NSString * _Nonnull)apiKey;
...
SWIFT_PROTOCOL("_TtP7LeapSDK12LeapCallback_")
